...
export default function Dashboard({
  ...
  return (
      <>
        {helmet()}
        <TesterSidebar route={"dashboard"} openFromHeader={isMenuOpen}>
          <Container className="aq-pb-3">
            <PageTitle   as="h2" size="regular" subtitle={t('This is your personal dashboard. From here you can check out your stats, keen an eye on the progress of your work and find new campaigns to apply for. Have fun!')}>
              {t("Dashboard")}
            </PageTitle>
            <BSGrid>
              <BSCol size="col-lg-9 ">
              ...
              <BSCol size="col-lg-3">
                <div className="stick-to-header-lg ">
                  <Card className="aq-mb-3" title={t("Your Performance")} shadow={true}>
                    <PerformanceData/>
                  </Card>
                </div>
              </BSCol>
